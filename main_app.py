...
if __name__ == "__main__":
    st.sidebar.image("logo.png", width= 225)
    with st.sidebar:
    ...
    if nav_option == 'Home':
        ...
        st.write("AgroFriendly is your agricultural companion, providing recommendations for crop, predicting the yield of your produce, determine the market price of your harvest and predict the")
